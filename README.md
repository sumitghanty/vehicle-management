...
- A smaller tracked database is available at `server/data/vehicle_management_lite.db` for quick download/share.
- It includes full master data plus a reduced operational slice (up to March 2022) to keep file size low.
- To regenerate the full database locally, run backend seed (`npm run seed`).
